...
if __name__ == '__main__':
    ...
    stock = os.environ.get("LOB_GAN_STOCK", "0056")
    ...
    if df.empty:
        ...
        #params
        lr_g = float(os.environ.get("LOB_GAN_LR_G", "0.00375"))
        lr_d = float(os.environ.get("LOB_GAN_LR_D", "0.001"))
        ...
        #batch size
        batch_size = int(os.environ.get("LOB_GAN_BATCH_SIZE", "50"))
        ...
        epochs = int(os.environ.get("LOB_GAN_EPOCHS", "200"))
